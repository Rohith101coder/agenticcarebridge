      ...
      >
        ...
        <div className="bg-white shadow-xs py-2 mb-3 sticky-top z-1">
          <div className="container px-4 d-flex align-items-center justify-content-between">
            ...
            <h5 className="fw-bold mb-0 text-success">Children Management</h5>
        ...
        <div className="container px-3 px-md-4" style={{ maxWidth: "1000px" }}>
          ...
          <div className="bg-white shadow-sm rounded-4 p-4 p-md-5 text-center min-vh-50 d-flex flex-column align-items-center justify-content-center py-5">
            <div className="bg-success bg-opacity-10 p-4 rounded-circle mb-4 text-success">
              <FaChild size={50} className="d-md-none" />
              <FaChild size={60} className="d-none d-md-block" />
            </div>
            <h3 className="fw-bold text-success mb-2 fs-4 fs-md-3">
              Feature Coming Soon
            </h3>
            <p className="text-muted mb-0 small" style={{ maxWidth: "400px" }}>
